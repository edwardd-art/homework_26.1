...
INSTALLED_APPS = [
    ...
    'products',
    'users',  # Добавлено приложение пользователей
]

# MIDDLEWARE - ВАЖНО! Проверьте, что все middleware на месте
MIDDLEWARE = [
...
# TEMPLATES - ВАЖНО! Проверьте настройки
TEMPLATES = [
    {
...
# Кастомная модель пользователя - ВАЖНО!
...
# Для реальной почты раскомментируйте:
